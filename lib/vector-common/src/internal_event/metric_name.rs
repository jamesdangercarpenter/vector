...
pub enum CounterName {
    ...
    ApiStartedTotal,
    AwsS3DeliveryErrorsCount,
    AwsS3DeliveryErrorsTotal,
    AwsS3ObjectsDeliveredTotal,
    AwsS3ObjectsErroredCount,
    AwsS3ObjectsErroredTotal,
    CheckpointsTotal,
    ChecksumErrorsTotal,
...
impl CounterName {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AwsS3DeliveryErrorsCount => "aws_s3_delivery_errors_count",
            Self::AwsS3DeliveryErrorsTotal => "aws_s3_delivery_errors_total",
            Self::AwsS3ObjectsDeliveredTotal => "aws_s3_objects_delivered_total",
            Self::AwsS3ObjectsErroredCount => "aws_s3_objects_errored_count",
            Self::AwsS3ObjectsErroredTotal => "aws_s3_objects_errored_total",
